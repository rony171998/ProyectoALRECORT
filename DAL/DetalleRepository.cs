...
namespace DAL
{
    public class DetalleRepository
    {
        ...
        public void Guardar(Detalle detalle)
        {
            ...
            {
                command.CommandText = "Insert Into detalle_factura values (:detalle_id,:cantidad,:valorunitario,:valortotal,:Id_servicio,Id_factura)";
                ...
                command.Parameters.Add("Id_servicio", OracleDbType.Varchar2).Value = detalle.Id_Servicio;
        ...
        public int Modificar(Detalle detalle)
        {
            using (var command = _connection.CreateCommand())
            {
                command.CommandText = @"update detalle_factura set Descripcion=:Descripcion,Precio=:Precio
                                        where Id=:Id";
                command.Parameters.Add("Id", OracleDbType.Varchar2).Value = detalle.Id_detalle;
